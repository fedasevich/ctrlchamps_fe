...
const en = {
  ...
  notifications: {
    ...
    requestAccepted:
      '<0>{{username}}</0> accepted your request. You can schedule a Virtual Assessment now',
    requestRejected: '<0>{{username}}</0> rejected your request for an appointment',
    requestedAppointment: '<0>{{username}}</0> requested you for an appointment',
    rejectedAppointment: '<0>{{username}}</0> rejected the appointment',
    acceptedVA: '<0>{{username}}</0> accepted Virtual Assessment request',
    rejectedVA: '<0>{{username}}</0> rejected Virtual Assessment request',
    rescheduleVA: '<0>{{username}}</0> rescheduled Virtual Assessment',
    signOff: '<0>{{username}}</0> sent you an agreement for sign off',
    activityLogRequest: '<0>{{username}}</0> requested you to complete activity log',
    activityLogReview: '<0>{{username}}</0> requested you to review completed activity log',
    activityLogApproved: '<0>{{username}}</0> approved your activity log',
    activityLogRejected: '<0>{{username}}</0> rejected your activity log',
    requestedVA: '<0>{{username}}</0> has requested the Virtual Assessment',
    fiveMinBeforeVA: '<0>{{username}}</0> the Virtual Assessment will begin in 5 minutes',
    insufficientFirstHourPayment: 'Appointment canceled due to insufficient first hour payment.',
    pausedAppointment: 'Appointment with <0>{{username}}</0> is on pause',
    resumeAppointment: 'Appointment with <0>{{username}}</0> is active again',
  },
  adminMenu: {
    users: 'Users',
